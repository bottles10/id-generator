...
function renderIDCard() {
  ...
  var zodiac = faker.person.zodiacSign();
  var idCard = createUserCard(firstName.toUpperCase(), lastName.toUpperCase(), address, city, state, zip, phone, dob, job, email, gender, zodiac);
  var existingIdCard = idCardContainer.querySelector("#idCard");
  if (existingIdCard) {
